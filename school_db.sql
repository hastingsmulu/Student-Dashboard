...
--
-- Host: localhost
-- Generation Time: Jul 19, 2021 at 01:54 AM
...
INSERT INTO `feescollection` (`id`, `Student`, `RegNo`, `Class`, `Session`, `PaidAmount`, `Balance`, `Branch`, `Date`, `Remarks`) VALUES
(1, 'Wafula Chebukati', 'IEBC/2017', '2', '1', 24000, 6000, 'KCB', '2021-07-05', 'Topay ball');
...
INSERT INTO `messages` (`idm`, `name`, `gender`, `email`, `time`, `msgs`, `status`) VALUES
(1, 'Mumo', 'Male', 'hastingsmumo@gmail.com', '2021-07-16', 'we come back to this lower state in this america', 'new'),
(2, 'John Doe', 'Male', 'Example@abcmail.xyz', '2021-07-16', 'Example message Input', 'New'),
(3, 'Jane Doe', 'Female', 'Example@abcmail.xyz', '2021-07-16', 'Example message Input', 'New'),
(4, 'Grace Mimi', 'Female', 'gracemimi894@gmail.com', '2021-07-08', 'Want to go home', 'Old'),
(5, 'Julie Wangari', 'Female', 'Juliwangesh@gmail.com', '2021-07-14', 'Want to go Home', 'Old'),
(7, 'Kim Matei', 'Male', 'mateikim4@gmail.com', '2021-07-09', 'Want to go home', 'Old'),
(8, 'Shiro Waweru', 'Female', 'shikowawesh204@gmail.com', '2021-07-10', 'Want to go Home', 'Old');
...
CREATE TABLE `students` (
  ...
  `gyntwfd_username` text NOT NULL,
  `xyguf_passwd` varchar(255) NOT NULL,
...
INSERT INTO `students` (`ID`, `FullName`, `gyntwfd_username`, `xyguf_passwd`, `Gender`, `DOB`, `Photo`, `RegNo`, `Class`, `Stream`, `Session`, `Hostel`, `DOJ`, `Category`, `AcademicYear`, `no_subject`, `TotalFees`, `AdvanceFees`, `Balance`, `grsxcvg_status`, `Parent`, `Parent_contacts`) VALUES
(1, 'Wafula Chebukati', 'wafulacheb', '$2y$10$JtOSe109VLWyiQSY8e7P4.QEK7UAmTrmQ8YZkZ2lOSYif.SO.bOFi', 'Male', '1916-01-18', NULL, 'IEBC/2017', '2', 'W', '1', '1', '2018-05-02', NULL, 1, 11, 1, 10500, 500, 'In', 'Anna Chebukati', '07546894545'),
(2, 'Harry Den', 'denharry', '$2y$10$JtOSe109VLWyiQSY8e7P4.QEK7UAmTrmQ8YZkZ2lOSYif.SO.bOFi', 'Male', '1996-02-05', NULL, '852', '1', 'W', '1', '1', '2018-07-30', 0, 1, 0, 1, 500, 3500, 'In', 'Sarah Den Wendi', '07523468945'),
(3, 'Christine Gray', 'christinegray', '$2y$10$JtOSe109VLWyiQSY8e7P4.QEK7UAmTrmQ8YZkZ2lOSYif.SO.bOFi', 'Female', '1997-04-17', '04619000_1532957454.jpg', '123', '3', 'N', '1', '0', '2018-07-30', 0, 1, 0, 0, 5000, 3500, 'In', 'Bob Gary Gray', '07456832156'),
(4, 'Johnny Doe', '', '$2y$10$YCeq2atvKTnMOMqLs4Zgb.HmvQOPuwLEG3M3pRWfViHKc0S0827Wa', 'Male', '1996-03-16', '68070100_1532957566.png', '80', '1', 'E', '1', '1', '2018-07-30', 0, 1, 0, 1, 6000, 3500, 'In', 'Jane Doe', '07123456896'),
(5, 'Bruno Den', '', '$2y$10$YCeq2atvKTnMOMqLs4Zgb.HmvQOPuwLEG3M3pRWfViHKc0S0827Wa', 'Male', '1996-12-18', '24894200_1532957631.png', '366', '4', 'S', '1', '1', '2018-07-30', 0, 1, 0, 1, 2000, 3500, 'In', 'John Den Doe', '074584123212'),
(6, 'William Carter', '', '$2y$10$YCeq2atvKTnMOMqLs4Zgb.HmvQOPuwLEG3M3pRWfViHKc0S0827Wa', 'Male', '1996-09-15', '08808400_1532959007.png', '852', '2', 'E', '1', '0', '2018-07-30', 0, 1, 0, 0, 1500, 13500, 'In', 'Lil Wayne Carter', '074125345621');
